...
export class Login extends React.Component {
  ...
  async customSubmit(event) {
    ...
    alert(123);
    const bodyParams = {
      email: this.state.accessKey,
      password: this.state.secretKey,
    };

    const res = await axios.post("http://localhost:8000/api/login", bodyParams);
    ...
    return (
      <div className="login">
        ...
        <div className="hello" style={{ color: "white" }}>
          user role(must login): {this.state.userRole}
        </div>
        {/* end */}
        ...
        <div className="l-wrap">
          ...
          <form onSubmit={this.customSubmit.bind(this)}>
            <InputGroup
